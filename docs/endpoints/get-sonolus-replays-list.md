# `GET /sonolus/replays/list`

`/sonolus/replays/list` provides information of replays, and is used by Sonolus app to populate server replay list view.
...
```ts
type ReplayList = ItemList<ReplayItem>
```
